...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="http://localhost:8000/admin">
        ...
        <li class="nav-item">
            <a class="nav-link" href="index.html">
                ...
                <span>Danh sách bài đăng</span></a>
        </li>
